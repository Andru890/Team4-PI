...
public class ReservationModificationEntradaDto {

    @NotNull(message = "Debe proveerse el Id de la reservación que desea modificar")
    public Long id;
    ...
    public ReservationModificationEntradaDto() {
    }

    public ReservationModificationEntradaDto(Long id, Date dateIn, Date dateOut, String status, List<Product> products, User user) {
        this.id = id;
        this.dateIn = dateIn;
